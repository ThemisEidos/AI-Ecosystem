...
$VaultRoot = Join-Path (Split-Path $PSScriptRoot -Parent) "Obsidian Vault"
...
$RawResponse = pwsh (Join-Path (Split-Path $PSScriptRoot -Parent) "Scripts\Send-PDACommand.ps1") -Command "/planner" -Message $Message
