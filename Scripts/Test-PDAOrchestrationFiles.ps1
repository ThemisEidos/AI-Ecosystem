...
$Required = @(
    ...
    "Scripts\COOPER_PersonalityEngine.ps1",
    "Scripts\Get-COOPERPersonality.ps1",
    "Scripts\Set-COOPERPersonality.ps1",
    "Scripts\Update-COOPERPersonality.ps1",
    "Scripts\Test-COOPERPersonalityPersistence.ps1",
    "Scripts\Test-COOPERPersonalityV2.ps1",
    "Models\cooper-personality\personality.json",
    "Models\cooper-personality\profiles.json",
