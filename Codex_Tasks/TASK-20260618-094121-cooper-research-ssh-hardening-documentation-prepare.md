# Cooper, Research Ssh Hardening Documentation And Prepare Implementation Work For The Linux Collection

## Objective
Create an implementation-ready Codex task for the supplied project context.

## Background
- Source request: COOPER, research SSH hardening documentation and prepare implementation work for the Linux collection.
