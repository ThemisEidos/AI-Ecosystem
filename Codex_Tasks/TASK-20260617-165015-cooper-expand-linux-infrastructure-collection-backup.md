# Cooper, Create A Codex Task To Expand The Linux Infrastructure Collection With Backup And Recovery Documentation

## Objective
Create an implementation-ready Codex task for the supplied project context.

## Background
- Source request: COOPER, create a Codex task to expand the Linux Infrastructure collection with backup and recovery documentation.
